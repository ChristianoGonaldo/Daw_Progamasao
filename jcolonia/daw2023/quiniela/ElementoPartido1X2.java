...
public class ElementoPartido1X2 {
	 ...
	 * @throws Partido1X2Exception Avisa de que el método lanza una exceptión si no esta cerrada
	 */
	 ...
	 * {@link Partido1X2Exception} en caso contrario.
	 * @throws Partido1X2Exception Avisa que lanza una excepción si esta cerrada
	 */
	 ...
	 * @throws Partido1X2Exception Lanza la excepción del tipo Partido1X2
	 */
	...
	public static ElementoPartido1X2 of(String nombreLocal, String nombreVisitante, String resultadoPartido)
		...
		try {
			...
			VistaGeneral.mostrarError("Faltan datos para poder realizar las operaciones.");
		}
		return nuevoPartido;
	}
	...
	public String toStringCSV() {
		try {
			...
			VistaGeneral.mostrarError("Faltan datos.");
			e.printStackTrace();
		}
