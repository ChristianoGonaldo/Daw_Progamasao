...
class TestBásicosElementoPartido1X2 {
	...
	public void testCargaConsultaCorrectas() throws DatoPartido1X2Exception {
		...
		try {
			...
			VistaGeneral.mostrarError("Implmentacion incorrecta de codigo");
			e.printStackTrace();
	...
	public void testCargaFactoríaConsultaCorrectas() throws DatoPartido1X2Exception {
		...
		try {
			...
			VistaGeneral.mostrarError("Implementacion incorrecta de código.");
			e.printStackTrace();
		}
	...
	public void testCargaConsultaMinúsculas() throws DatoPartido1X2Exception {
		...
		try {
			...
			VistaGeneral.mostrarError("Implementacion incorrecta de codigo");
			e.printStackTrace();
		} catch (Partido1X2Exception e) {
			VistaGeneral.mostrarError("Implementacion incorrecta de codigo");
			e.printStackTrace();
